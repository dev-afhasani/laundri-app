          ...
          <div class="card-body">
            <form action="" method="get">
              <div class="form-group">
                <div class="row mb-2">
                  <label for="tahun" class="col-3 col-sm-auto col-form-label">Tahun</label>
                  <div class="col-auto">
                ...
                <div class="row mb-2">
                  <label for="bulan" class="col-3 col-sm-auto col-form-label">Bulan</label>
                  <div class="col-auto">
                    <select class="form-control" id="bulan" name="month">
                      @for ($i = 1; $i <= 12; $i++) @if ($i==$currentMonth) <option value="{{ $i }}" selected>
                        {{ $i }}</option>
                        @else
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @else
                    <select name="" id="status" data-id="{{ $item->id }}" data-val="{{ $item->status_id }}" class="select-status">
                      @foreach ($status as $s)
