        ...
        <div class="card">
          <div class="card-body">
                ...
                <div class="col-sm-8 col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-4">
                        <a id="tambah-servis" class="text-white btn btn-primary" data-toggle="modal" data-target="#addServiceModal"><i class="fas fa-plus"></i>
                          Servis</a>
                      </div>
                    </div>
                  </div>
            ...
            <ul class="nav nav-tabs mt-3" id="myTab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="kiloan-tab" data-toggle="tab" href="#kiloan" role="tab" aria-controls="kiloan" aria-selected="true">Kiloan</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="satuan-tab" data-toggle="tab" href="#satuan" role="tab" aria-controls="satuan" aria-selected="false">Satuan</a>
              </li>
            </ul>
            <div class="tab-content mt-3" id="myTabContent">
              <div class="tab-pane fade show active" id="kiloan" role="tabpanel" aria-labelledby="kiloan-tab">
                <table id="tbl-kiloan" class="table dataTable dt-responsive nowrap" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="#" class="badge badge-warning btn-ubah-harga" data-id="{{ $item->id }}" data-toggle="modal" data-target="#changePriceModal">Ubah Harga</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
              ...
              <table id="tbl-servis" class="table dataTable dt-responsive nowrap" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="#" class="badge badge-warning btn-update-cost" data-id="{{ $serviceType->id }}" data-toggle="modal" data-target="#updateCostModal">Ubah Harga</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
