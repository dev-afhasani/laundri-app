                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="form-check">
                      <input type="checkbox" class="form-check-input aktif-check" checked value="{{ $voucher->id }}">
                      <label class="form-check-label">Aktif</label>
                    </div>
                    @else
                    <div class="form-check">
                      <input type="checkbox" class="form-check-input aktif-check" value="{{ $voucher->id }}">
                      <label class="form-check-label">Aktif</label>
                    </div>
                    @endif
                  </td>
