        ...
        <div class="card">
          <div class="card-body">
            <form action="{{ route('admin.transactions.session.store') }}" method="post">
              ...
              <div class="form-group row">
                <label for="barang" class="col-sm-2 col-md-2 col-form-label">Barang</label>
                <div class="col-sm-6 col-md-4">
              ...
              <div class="form-group row">
                <label for="servis" class="col-sm-2 col-md-2 col-form-label">Servis</label>
                <div class="col-sm-6 col-md-4">
              ...
              <div class="form-group row">
                <label for="kategori" class="col-sm-2 col-md-2 col-form-label">Kategori</label>
                <div class="col-sm-6 col-md-4">
              ...
              <div class="form-group row">
                <label for="banyak" class="col-sm-2 col-md-2 col-form-label">Banyak</label>
                <div class="col-sm-2 col-md-1 mb-4">
                  <div class="input-group">
                    <input type="text" id="quantity" name="quantity" class="form-control input-number" value="1" min="1" max="100">
                  </div>
                </div>
                <div class="col-sm-4 col-md-3">
                  <button type="submit" id="tambah-transaksi" class="btn btn-primary btn-block">Tambah Transaksi</button>
                </div>
              </div>
            </form>
            <table id="tbl-input-transaksi" class="table mt-2 dt-responsive nowrap" style="width: 100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('admin.transactions.session.destroy', ['rowId' => $transaction['rowId']]) }}" class="btn btn-danger">Hapus</a>
                  </td>
                </tr>
                @endforeach
                @endif
