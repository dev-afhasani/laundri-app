            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="{{ route('member.vouchers.store', ['voucher' => $voucher->id]) }}" class="badge badge-primary" onclick="return confirm('Apakah anda yakin ingin menukar poin?')">Tukar</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
