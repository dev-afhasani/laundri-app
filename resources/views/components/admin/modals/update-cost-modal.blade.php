<div class="modal fade" id="updateCostModal" tabindex="-1" role="dialog" aria-labelledby="updateCostModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="serviceTypeForm" action="{{ route('admin.service-types.update', ['serviceType' => 'id']) }}" method="POST">
          @method('PATCH')
          @csrf
