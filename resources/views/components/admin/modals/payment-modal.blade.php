      ...
      <form action="{{ route('admin.transactions.store') }}" method="post">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="number" class="form-control form-control-lg" id="sub-total" value="{{ isset($totalPrice) ? $totalPrice : '0' }}" disabled>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control form-control-lg" id="total-harga" value="{{ isset($totalPrice) ? $totalPrice : '0' }}" disabled>
          </div>
          <div class="form-group">
