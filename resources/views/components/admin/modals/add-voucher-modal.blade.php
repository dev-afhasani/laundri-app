      ...
      <form action="{{ route('admin.vouchers.store') }}" method="post">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="potongan" name="discount_value" placeholder="Besar potongan harga" required>
          </div>
          <div class="form-group">
            <label for="poin">Poin diperlukan</label>
            <input type="number" class="form-control" id="poin" name="point_need" placeholder="Poin diperlukan" required>
          </div>
        </div>
